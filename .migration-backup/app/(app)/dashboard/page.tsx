...
import { Card, Pill, ProgressBar, Stat, Disclaimer } from "@/components/ui";
  ...
  return (
    <>
      ...
      <div className="space-y-6 p-8">
        ...
        {/* Document completeness + estimate */}
