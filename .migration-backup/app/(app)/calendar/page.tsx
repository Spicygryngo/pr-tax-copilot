    ...
    <>
      ...
      <div className="space-y-6 p-8">
        ...
        <Disclaimer>
          ...
          are general rules and may change by official guidance. Notification emails (60/30/14/7/3/1
          days) arrive in Phase 6. Confirm every date with Hacienda, DDEC, or SURI.
        </Disclaimer>
      </div>
    </>
  );
