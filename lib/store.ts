// Local-mode data store (browser localStorage).
//
// This is the single data-access seam for Phases 1-3. Pages call these
// functions; they neither know nor care whether persistence is localStorage or
// Supabase. To go to production, implement the same function signatures against
// Supabase (with RLS) behind isSupabaseConfigured() and the rest of the app is
// unchanged.
...
// --- Lightweight local auth (LOCAL MODE ONLY) -----------------------------
// Real auth uses Supabase Auth. This stub lets you walk the full flow offline.
...
export function saveProfile(profile: UserTaxProfile): void {
  ...
  // Regenerate checklist on profile save, preserving existing item statuses.
...
// --- Account deletion (build plan section 17) -----------------------------
